...
const muteUnmute = () => {
    console.log("myVideoStream.getAudioTracks():", myVideoStream.getAudioTracks());
    const enabled = myVideoStream.getAudioTracks()[0].enabled;
    console.log("Enabled before toggle:", enabled);
    if (enabled) {
    ...
    console.log("Enabled after toggle:", myVideoStream.getAudioTracks()[0].enabled);
};
